...
<div class="container py-6">
	...
	<div id="d-tambahProduk" class="dialog bg-warning" data-role="dialog">
		...
		<form action="{{route('produk.save')}}" method="POST">
			<div class="dialog-content">
				<div class="dialog-body">
					...
					<div class="dialog-body">
						<div class='p-2'>
							<div class='abc input' style="background-color:black;">
			...
			<div class="dialog-actions text-right">
				...
				<button type="submit" class="button success js-dialog-close success" onclick="Metro.notify.create('This is a notify.', 'Title', {keepOpen: false});"><span class="mif-checkmark"></span>&nbsp;Edit</button>
			</div>
		</form>
	</div>
	<div id="d-editProduk" class="dialog bg-warning" data-role="dialog">
		<div class="dialog-header">
			<div class="dialog-title text-center">Tambah Produk</div>
		</div>
			...
			<div class="dialog-content">
				<div class="dialog-body">
					...
					<div class="dialog-body">
						<div class='p-2'>
							<div class='abc input' style="background-color:black;">
								<input type='text' value="{{ $produk->nama }}" data-role='input' data-prepend='Nama' placeholder='Nama Produk' data-validate='minlength=3' class=' data-role-input='true' name='nama'>
							</div>
							<div class='abc input'>
								<select data-role="select" name="kategori">
									<option value="">Pilih Kategori</option>
							...
							<div class='abc input'>
								<input type='number' value="{{ $produk->jumlah }}" data-role='input' data-prepend='Jumlah' placeholder='Jumlah' data-validate='minlength=6' class=' data-role-input='true' name='jumlah'>
							</div>
							<div class='abc input'>
								<select data-role="select" name="satuan">
							...
							<div class='abc input'>
								<input type='number' value="{{ $produk->hargabeli }}" data-role='input' data-prepend='Harga Beli' placeholder='Harga Beli' data-validate='minlength=5' class=' data-role-input='true' name='hargabeli'>
							</div>
							<div class='abc input'>
								<input type='number' value="{{ $produk->hargajual }}" data-role='input' data-prepend='Harga Jual' placeholder='Harga Jual' data-validate='minlength=5' class=' data-role-input='true' name='hargajual'>
							</div>
...
<table class="table striped table-border mt-4" id="example" data-role="table" data-pagination="true">
	<thead>
		<tr>
			...
			<th class="sortable-column text-center bg-info">Nama</th>
