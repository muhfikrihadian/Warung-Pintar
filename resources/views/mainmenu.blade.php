...
<body class="a-color fg-white h-vh-100 m4-cloak">
    ...
    <div class="container-fluid start-screen h-100">
        <h2 class="start-screen-title"><a href="{{ route('logout') }}"onclick="event.preventDefault();document.getElementById('logout-form').submit();"><span class="mif-settings-power icon fg-red"></span></a>&nbsp;Selamat Datang {{ Auth::user()->name }} Di Warung Pintar</h2>
        ...
        <div class="container tiles-area clear">
            <div class="tiles-grid tiles-group size-3 fg-white">
                @if(Auth::user()->akses == "SuperAdmin")
                <div data-role="tile" data-size="wide" data-effect="animate-slide-right">
                    <a href="{{route('toko.all')}}" data-role="tile" class="slide bg-indigo fg-white">
                        <div data-role="tile" class="bg-cyan fg-white" data-size="wide">
                            ...
                            <span class="branding-bar">Master Toko</span>
                        </div>
                    </a>
                </div>
                @endif
                @if(Auth::user()->akses == "SuperAdmin" || Auth::user()->akses == "Kasir")
                <div data-role="tile" data-size="wide" data-effect=" wow bounceInLeft">
