...
<div class="container py-6">
	<!-- START MODAL -->
	<h3 class="text-center">Informasi Toko</h3>
	<div class="img-container">
	<img src="https://upload.wikimedia.org/wikipedia/id/thumb/7/7b/Logo_SMK_N_10_Jakarta.jpeg/175px-Logo_SMK_N_10_Jakarta.jpeg" style="width:150px; height:150px;">
	<div class="image-overlay op-amber"></div>
</div>
	<div id="d-tambahToko" class="dialog" data-role="dialog">
		<div class="dialog-header primary">
			<div class="dialog-title text-center primary">Tambah Toko</div>
		</div>


		<form action="{{route('toko.save')}}" method="POST" enctype="multipart/form-data" >
				...
				<div class="dialog-body">
					...
					<div class="dialog-body">
						<div class='p-2'>
							...
							<div class='abc input'>
								<input type="file" data-role="file"  data-prepend='Logo' placeholder='Logo' data-validate='minlength=5' class=' data-role-input='true' name='logo'>
							</div>
						</div>
					</div>
				</div>
...
<table class="table striped table-border mt-4 bg-info" id="example" data-role="table" data-pagination="true">
	<thead>
		<tr>
