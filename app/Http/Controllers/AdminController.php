...
class AdminController extends Controller
{
    ...
    $r->file('logo')->move(public_path('instansi'), $gambar);
	...
	function editproduk(Request $r){
		DB::table('produks')->where('_id', $r->input('id'))->update(
      [
      'nama' => $r->input('nama'),
			'kategori' => $r->input('kategori'),
			'jumlah' => $r->input('jumlah'),
			'unit' => $r->input('satuan'),
			'hargajual' => $r->input('hargajual'),
